...
attendance_recipe <- recipe(weekly_attendance ~ ., data = attendance_split) %>% 
  # step_impute_knn(strength_of_schedule)
...
rf_final_perf_base <- rf_final_perf
perf_median_impute <- rf_final_perf_base
perf_knn_impute <- rf_final_perf
perf_median_corr <- rf_final_perf
perf_median_corr_dummy <- rf_final_perf
perf_median_corr_factors <- rf_final_perf
